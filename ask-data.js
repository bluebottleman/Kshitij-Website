/* Content index for the "Ask" widget (ask.js). Each entry is one topic a
   visitor might ask about, with the keywords ask.js matches queries
   against, a one-to-two sentence answer, and a link to the full case study.
   Kept as plain data (not fetched/generated) so it's easy to hand-edit as
   new projects get added to the site — just add another object here. */
window.SITE_QA_INDEX = [
  ...
  },
  {
    ...
    page: "product/",
    keywords: ["tata", "neucard", "ai", "midjourney", "product marketing", "cross-functional", "ipl", "partner brand"],
  ...
  {
    title: "Schbang Digital",
    page: "marketing/",
    keywords: ["schbang", "domino's", "rupeek", "onsitego", "team management", "head of design"],
    answer: "At Schbang, Kshitij led a team of 3 junior designers across three brands at once (Domino's, Rupeek, OnSiteGo), running daily syncs with marketing and analysts while reporting to the Head of Design."
  },
  {
